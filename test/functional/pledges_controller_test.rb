...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { created_time: @pledge.created_time, organization_id: @pledge.organization_id, user_id: @pledge.user_id }
    end
  ...
  test "should update pledge" do
    put :update, id: @pledge, pledge: { created_time: @pledge.created_time, organization_id: @pledge.organization_id, user_id: @pledge.user_id }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
